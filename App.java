	 ...
	 public static void main( String[] args )
	    {
	        ...
	        try
	        {
	    		...
	    		doctors.add(new Doctor("Dr.Surbhi Anand","Endodontist","8623917281","Delhi", department));
	    		
	    		
	    		Room room = new Room("Third Floor");
	    		Patient s1 = new Patient("Rushi","8623917281","Kurukali","21","Male",doctors,room);
	    		Patient s2 = new Patient("Prakash","8623917281","Bele","28","Male",doctors,room);
